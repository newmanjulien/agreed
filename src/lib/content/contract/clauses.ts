          ...
          answer: [
            ...
            },
            {
              parts: [
                {
                  type: "text",
                  text: "As you use Agreed, you may provide information about the clauses in your contracts and how you prefer to negotiate them. That information remains yours and will be deleted if you leave Agreed.",
                },
              ],
            },
            {
              parts: [
                {
                  type: "text",
                  text: "You will also manage signatures and signed contracts through Agreed. Those materials are handled by our e-signature partner, BoldSign, rather than stored by Agreed, and are subject to BoldSign’s applicable terms and privacy practices.",
                },
              ],
            },
          ],
